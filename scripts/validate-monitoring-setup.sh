#!/bin/sh
###############################################################################
# Monitoring Stack - Pre-Deployment Validation & Setup
#
...
log_error() {
    echo "[monitoring-validation] ERROR: $*" >&2
}
...
ensure_dir_with_ownership "${APPDATA_PATH}/monitoring/secrets" "472:472" "750"
